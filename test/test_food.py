...
class foodTestCase(unittest.TestCase):
    ...
    def test_Equal(self):
        ...
        nutrient1 = Nutrient("potassium",["potasio","pottasche"],"mg",126,125,127,"mineral")
        nutrient2 = Nutrient("magnesium",["magnesio","magnésium"],"mg",10,9,11,"mineral")
        nutrient3 = Nutrient("cholesterol",[],"g",373,370,375,"carbohydrate")

        nutrient2 = Nutrient("sucrose",["sacarosa","saccharose"],"g",6,3.5,5.3,"carbohydrate")
        
        nutrient4 = Nutrient("lactose",["lactosa"],"g",6,3.5,5.3,"mineral")
        nutrient5 = Nutrient("vitamin-b1-tiamina",["vitamina-A-IU"],"mg",6,3.5,5.3,"vitamin")
        ...
        food_object1 = Food(["chicken-egg","huevo-de-gallina","Oeuf-de-poule"],[],[nutrient1,nutrient2,nutrient3],desctiption,action,unit,value,0,0,0,0)
        food_object2 = Food(["chicken-egg","ovo-de-pollo","Oeuf-de-poule"],[],[nutrient1,nutrient2,nutrient3],desctiption,action,unit,value,0,0,0,0)
        
        self.assertEqual(food_object1.EqualTo(food_object2), True, "Incorrect value")
        food_object1 = Food(["chicken-egg","huevo-de-gallina","Oeuf-de-poule"],[],[nutrient1,nutrient5,nutrient3],desctiption,action,unit,value,0,0,0,0)
    ...
    def test_HasNutrient(self):
        ...
        nutrient2 = Nutrient("",["magnesio",""],"mg",10,9,11,"mineral")
        self.assertEqual(food_object1.HasNutrient(nutrient2), True, "Incorrect nutrient")

        nutrient2 = Nutrient("",["majnesio",""],"mg",10,9,11,"mineral")
        self.assertEqual(food_object1.HasNutrient(nutrient2), False, "Incorrect nutrient")

        nutrient2 = Nutrient("",["",""],"mg",10,9,11,"mineral")
        self.assertEqual(food_object1.HasNutrient(nutrient2), False, "Incorrect nutrient")
